...
public class ShellFactory {
     ...
     */
    public static Shell createConsoleShell(String prompt, String appName, Object... handlers) throws Exception {
     ...
     * @param prompt Prompt to be displayed
     * @param appName The app name string
     * @param mainHandler DtQueryHandler command handler
    ...
    public static Shell createConsoleShell(String prompt, String appName, Object mainHandler,
            MultiMap<String, Object> auxHandlers) throws Exception {
        ConsoleIO io = new ConsoleIO();
     ...
     * @return Shell that can be either further customized or run directly by calling commandLoop().
     */
    public static Shell createConsoleShell(String prompt, String appName, Object mainHandler) throws Exception {
